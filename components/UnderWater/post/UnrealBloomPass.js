...
class UnrealBloomPass extends Pass {
  ...
  render(renderer, inputBuffer, outputBuffer, deltaTime, maskActive) {
    ...
    if (this.renderToScreen) {
      ...
      this.basic.map = inputBuffer.texture;
    ...
    this.highPassUniforms["tDiffuse"].value = inputBuffer.texture;
